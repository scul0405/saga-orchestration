...
import (
	...
	"github.com/scul0405/saga-orchestration/services/account/infrastructure/db/postgres"
	portgrpc "github.com/scul0405/saga-orchestration/services/account/ports/grpc"
	porthttp "github.com/scul0405/saga-orchestration/services/account/ports/http"
	"github.com/scul0405/saga-orchestration/services/account/repository/postgres_repo"
	customersvc "github.com/scul0405/saga-orchestration/services/account/service/account"
	authsvc "github.com/scul0405/saga-orchestration/services/account/service/auth"
	"log"
	"os"
	"os/signal"
	"syscall"
