...
import (
	...
	"github.com/scul0405/saga-orchestration/services/product/app/query"
	"github.com/scul0405/saga-orchestration/services/product/interface/http/dto"
...
func (r *Router) CreateProduct(c *gin.Context) {
	...
	err := r.app.Commands.CreateProduct.Handle(c, command2.CreateProduct{
...
func (r *Router) UpdateProductDetail(c *gin.Context) {
	...
	err := r.app.Commands.UpdateProductDetail.Handle(c, command2.UpdateProductDetail{
