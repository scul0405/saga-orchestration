...
import (
	...
	entity "github.com/scul0405/saga-orchestration/services/account/internal/domain/entity"
...
func (m *MockJWTAuthRepository) GetCustomerCredentials(ctx context.Context, email string) (bool, *valueobject.CustomerCredentials, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCustomerCredentials", ctx, email)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(*valueobject.CustomerCredentials)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
