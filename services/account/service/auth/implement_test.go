...
func TestAuth(t *testing.T) {
	...
	testcases := []struct {
		name          string
		setupAuth     func() *valueobject2.AuthPayload
		checkResponse func(t *testing.T, info *valueobject2.AuthResponse, err error)
	}{
		{
			name: "success",
			setupAuth: func() *valueobject2.AuthPayload {
				...
				require.NoError(t, err)
				return &valueobject2.AuthPayload{
					AccessToken: token,
				}
			},
			checkResponse: func(t *testing.T, info *valueobject2.AuthResponse, err error) {
	...
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
			...
			customer := &entity.Customer{
				...
				Active:   true,
				Password: "secret",
				PersonalInfo: &valueobject2.CustomerPersonalInfo{
					FirstName: "dep",
					LastName:  "trai",
					Email:     "deptrai@gmail.com",
				},
				DeliveryInfo: &valueobject2.CustomerDeliveryInfo{
					Address:     "123 abc",
...
func TestLogin(t *testing.T) {
	...
	require.NoError(t, err)
	customerCred := &valueobject2.CustomerCredentials{
